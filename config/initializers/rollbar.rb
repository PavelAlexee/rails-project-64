...
if defined?(Rollbar)
  Rollbar.configure do |config|
    ...
    config.request.filter = %w[password password_confirmation]
    config.person_username_method = 'id'
  ...
  Rails.logger.warn 'Rollbar gem not found. Skipping Rollbar configuration.'
end
